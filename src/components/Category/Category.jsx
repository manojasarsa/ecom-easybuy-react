...
const Category = () => {
    return (
        <nav className="main_nav flex flex_align_center">
            ...
            <Link className="nav_item flex flex_col flex_align_center" to="/productlist">Boys
            ...
            <Link className="nav_item flex flex_col flex_align_center" to="/productlist">Girls
